...
// corpus into the V&V coverage matrix and renders docs/FIDELITY.md (doc: verification-and-validation.html §6, §7).
...
export function renderFidelity(matrix: CoverageMatrix, report: CalibrationReport): string {
  ...
  L.push('');
  L.push(
    'The V&V coverage matrix as a published report (doc: `docs/design/verification-and-validation.html`). It crosses ' +
