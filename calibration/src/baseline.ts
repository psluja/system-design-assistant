// THE FIDELITY BASELINE — pinned post-fit residuals the standing test and `calibrate --check` guard (TASK-93,
// Job 4). Fidelity is guarded exactly like the solver oracle guards solver agreement: if a content/engine change
