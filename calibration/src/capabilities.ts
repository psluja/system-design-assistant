// THE CAPABILITY REGISTRY — the ONE declared home for the V&V coverage axis (doc: verification-and-validation.html
// §4a, §5, §6). Every question the engine answers (6 solver capabilities) and every modeling family the tool can
