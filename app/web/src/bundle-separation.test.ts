...
// BUNDLE-SEPARATION LINT (docs/design/solver-contract.html §6, migration step 6). The prize of TASK-79 is
...
// TASK-81: the WebGPU EvaluateBatch backend (@sda/solver-contract/gpu — WGSL driver + the cell-network compiler)
