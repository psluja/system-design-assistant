...
export interface SimWorkerRequest {
  ...
  // FLOW-SCOPED LAG pairs to measure (doc: latency-semantics-v2 §3) — the declared (source, terminal) station
...
export type SimWorkerResponse =
  | {
      ...
      // RETRY OUTCOME (doc: retry-feedback §3) — the useful work vs failures a retry policy produces, measured by
