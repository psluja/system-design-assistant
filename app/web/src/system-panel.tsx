...
// The SYSTEM lens (doc-11 "real by default"), extracted from app.tsx (TASK-89) — the whole-design blocks of the
// System drawer. LAYOUT (TASK-94 owner-approved rebuild, 2026-07-11): a full-width VERDICT line on top, then a tidy
...
export function SystemPanel({
  ...
  // AMBIENT UNCERTAINTY (TASK-81) — the Monte-Carlo distribution, present only when a range is declared AND a run
