...
// THE COMPOSITION ROOT (docs/design/solver-contract.html §5) — browser twin. The ONE place the web app binds
...
/** The runtime mode the browser binds (TASK-79 phase 3):
 ...
 *
 *  ROLLBACK (TASK-79 phase 3): change the ONE default below from `'native'` to `'incumbent'` and the web shell
