...
// The PROBLEMS lens (an IDE-style Error List), extracted from app.tsx. One table over the ONE verdict
// list: the presenter's `problemRows` (violations → warnings → unverified, plus build errors) followed by the
// qualitative GUARANTEE violations — both computed upstream, never re-derived
        ...
        {problems.length === 0 && guaranteeProblems.length === 0 ? (
          ...
          <table className="problems">
            ...
            <tbody>
              ...
              {/* GUARANTEE violations — a broken qualitative promise, listed
