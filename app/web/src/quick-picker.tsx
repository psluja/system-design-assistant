...
// The in-canvas QUICK-ADD picker ("canvas smoothness") — an n8n-grade creation flow. A small popover
...
export interface QuickPickerState {
  ...
  // An EXPLICIT flow-space placement for the new node, overriding "place at the anchor". The port "+"
