...
// THE IDEAL LAYOUT — the OBJECTIVE (doc: ideal-layout §2). A layout is chosen by maximising a score: hard
 ...
 *  SEPARATION terms (TASK-88 owner re-ratification): edge traceability, made first-class. */
 ...
 *
 * R4 OWNER RE-RATIFICATION (TASK-88 field test, HEAD 4e9152f). The owner tested the IDEAL layout against Tidy and
...
// ── The SEPARATION terms (R4, TASK-88) — edge traceability, scored on the real routed polylines ─────────────────
//
