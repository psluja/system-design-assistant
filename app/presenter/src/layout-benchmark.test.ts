...
// THE BENCHMARK (doc: ideal-layout §6) — "najlepsi" made a MEASURED claim, not a felt one. For each committed
...
describe('layout benchmark — SDA (Tidy vs semantic vs optimizer), always on', () => {
  ...
  // THE TRACEABILITY GATE (R4, TASK-88 owner verdict). The owner field-tested the ideal layout and ruled it WORSE
