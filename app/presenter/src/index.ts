...
// THE IDEAL LAYOUT (doc: ideal-layout) — semantic placement + a seeded search scored on real routes. The
...
// THE IDEAL LAYOUT — the GPU PROPOSER (doc: ideal-layout §3.3–3.4). The fp32 straight-line proxy
