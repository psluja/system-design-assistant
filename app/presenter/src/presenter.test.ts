...
// RETRY OUTCOME rows. Past saturation retries LOWER goodput; the summary must
...
// FLOW-SCOPED LAG rows: the presenter renders a "Propagation lag" section from the
...
// ── LATENCY SEMANTICS v2 · R3 surfaces ────────────────────────────────────────
