...
// RETRY OUTCOME rows (doc: retry-feedback §3, TASK-76 R3). Past saturation retries LOWER goodput; the summary must
...
// simVerdicts — the SHARED DES-fed verdict composer both shells use (TASK-76 R3). It merges the tail (p99) and
