...
// THE IDEAL LAYOUT — the GPU PROPOSER's WebGPU driver (doc: ideal-layout §3.3; TASK-88 R3). A per-design WGSL
...
// this. This module MIRRORS the gpu-module discipline proven by TASK-81 (engine/solver-contract/src/gpu/webgpu.ts):
