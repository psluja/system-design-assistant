...
// THE IDEAL LAYOUT — the GPU PROPOSER seam (doc: ideal-layout §3.3–3.4; TASK-88 R3). This binds the fp32 proxy
...
// TASK-81 measured it flat in batch size). So the product path ranks with the deviceless twin, which computes
