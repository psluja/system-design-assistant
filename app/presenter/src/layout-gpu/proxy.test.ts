...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────
// THE IDEAL LAYOUT — the GPU PROPOSER's DECLARED DIFFERENTIAL (doc: ideal-layout §3.3–3.4), deviceless
...
//
// R4 RE-DERIVATION (the separation round). The objective gained three routing-DEPENDENT separation terms
