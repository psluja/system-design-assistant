...
// BUNDLE-SEPARATION LINT for the layout GPU proposer (doc: ideal-layout §3.3), mirroring the web
// shell's own lint (app/web/src/bundle-separation.test.ts) and the discipline. The WebGPU driver
