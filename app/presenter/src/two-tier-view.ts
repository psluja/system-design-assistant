...
// @problem The ambient two-tier evaluation (doc: load-stages §10) must render as ONE compact block both shells
 ...
 * (doc: load-stages §11, honest visibility). It max-pools the SAME λ̂ shape the sweep/DES play ({@link shapeSeries},
...
/**
 * The ambient two-tier SummarySection (doc: load-stages §10). Tier-1 rows (basis analytic, always present once a
