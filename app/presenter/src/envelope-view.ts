...
// THE ENVELOPE AS THE DEFAULT ANSWER — the ONE composition both shells render for the
// capacity envelope. With NO declared demand the tool still answers: how far each origin can be pushed before an SLO
// breaks, WHAT breaks first, and where the queueing knee sits. This is the guided-emptiness fix: a
