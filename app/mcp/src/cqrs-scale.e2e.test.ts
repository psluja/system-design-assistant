...
// — the CQRS dogfood at scale + the honest-decline mislabel regression.
//
...
describe('CQRS dogfood: backward search converges on the committed 23-node design', () => {
...
describe('the mislabel regression: a decline/throw is never dressed as a time limit', () => {
...
describe('a cyclic flow names the cycle and points to request classes (the saga back-edge shape)', () => {
