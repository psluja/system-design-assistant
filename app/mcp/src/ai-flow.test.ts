...
// TASK-84: the uncertainty WORKFLOW the owner's Copilot session wandered through (no recipe, forked the file,
...
// TASK-84 F1: apply_design must report ALL problems in ONE response and apply NOTHING (never first-error-abort to a
