...
// THE COMPOSITION ROOT (docs/design/solver-contract.html §5) for the node MCP server. This is the ONE place
...
/** The runtime mode a shell binds (TASK-79 phase 3):
 ...
 *
 * ────────────────────────────────────────────────────────────────────────────────────────────────────────────
 * ROLLBACK (owner's call, TASK-79 phase 3 — "w najgorszym przypadku przełączymy z powrotem"): change the ONE
