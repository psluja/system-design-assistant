...
// compare_options — the in-app "run backwards / synthesize a choice" capstone: pick ONE node and
...
// arrive as CONTRACT CAPABILITIES in a `SolverBindings` — the SAME record
