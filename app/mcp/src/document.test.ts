...
describe('generate_doc MCP tool — the deliverable from the live verified model', () => {
  it('emits the design document with the COMPUTED numbers, C4 view and cost table', () => {
    ...
    const md = r.text;
    // Design-document sections present.
    ...
    // the unmodelled hallmark sections are flagged, never silently absent.
