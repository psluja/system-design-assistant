...
export interface SimWorkerRequest {
  ...
  // FLOW-SCOPED LAG pairs (doc: latency-semantics-v2 §3) — the declared (source, terminal) pairs the main thread
...
export type SimWorkerResponse =
  | {
      ...
      readonly p95: number;
      readonly p99: number;
      // RETRY OUTCOME (doc: retry-feedback §3) — goodput/failures/amplification the DES measured, and whether a
