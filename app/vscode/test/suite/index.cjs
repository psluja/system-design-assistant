...
exports.run = async function run() {
  ...
  // end (doc: latency-semantics-v2 §4, R3). The p99 SLO on `pg` (a requirement-bearing node) is now judged against
  ...
  // 6 — LIVE-RELOAD ROUND-TRIP (TASK-84): an EXTERNAL write to the open .sda.json — exactly what the MCP
