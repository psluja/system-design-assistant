...
describe('sectionIcon', () => {
  it('maps each System-summary section title to its Testing-view glyph', () => {
    ...
    expect(sectionIcon('Load stages · transient')).toBe('pulse'); // the ambient two-tier read-out
    ...
    // assumption model — the envelope ('Load limits') + worlds sections get their glyphs
