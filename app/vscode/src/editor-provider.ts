...
/**
 * Build the QuickPick items for the quick-add picker: group the options BY KIND, with a native separator
    ...
    const onMessage = panel.webview.onDidReceiveMessage((raw: unknown) => {
      ...
      switch (msg.type) {
        ...
        case 'selection':
          ...
          break;
        case 'pick':
          // The QUICK-ADD picker: the webview computed the legality-filtered options; show them as a
