...
// HTML RENDERER (doc: design-doc-v2 R2) — these tests pin the STRUCTURAL invariants of the generated document, the
...
describe('renderHtml — guarantees section (doc: guarantee-propagation §4)', () => {
...
describe('renderHtml — flow-scoped lag block (doc: latency-semantics-v2 §3)', () => {
