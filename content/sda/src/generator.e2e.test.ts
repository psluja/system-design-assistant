...
// GENERATE AT PORTS — content lowering. `generate(level, cycles?)` is the primitive
...
describe('the reconciled level cell — one address for worlds / MC / sweep', () => {
...
describe('relay + generate — the mixed case the port family newly allows', () => {
...
describe('the DES projection threads the cycles — and stays silent for a flat generator', () => {
