...
// TASK-79's batch-evaluation seam). Every soft input becomes a declared RANGE; every conclusion becomes a
...
export interface UncertaintyInput {
  ...
  readonly seed?: number;
  /** OPTIONAL best-effort cancellation channel, threaded straight to the batch evaluator (TASK-81 ambient loop):
