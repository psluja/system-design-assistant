...
// THE DERIVED TRIO (doc: assumption-model §5 — "this could be a hit"). Don't ask a lazy architect to invent three
 ...
 * under-loads the design below its STATED REQUIREMENT (TASK-86 F6). The requirement floor is the load the design
