...
// responseLatency: a node's REAL request→response latency = its own sojourn + the composition of its
...
// latencyBreakdown: splits a node's response into base (declared service) + queue (its OWN congestion —
