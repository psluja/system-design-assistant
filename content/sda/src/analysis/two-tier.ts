...
// @where-tested content/sda/src/analysis/two-tier.e2e.test.ts

// THE TWO-TIER EVALUATION — the load-bearing composition. Tier 1 (the analytic time-sweep,
...
// ─────────────────────────────────────────────────────────────────────────────────────────────────────────────
// The re-homed SURVIVAL VERDICT — moved here verbatim from the
...
/** The composed two-tier result — two LABELLED bases, honest. Tier 2 is absent for a
...
/**
 * Build the Tier-2 DES job for the worst window a Tier-1 {@link TimeSweep} found. Returns
...
/**
 * Run the Tier-2 DES for a prepared {@link Tier2Job} — the seeded transient over the
...
/**
 * The SYNC two-tier evaluation — Tier-1 sweep then Tier-2 DES on its worst window, both in
