...
// NO-MAGIC-NUMBERS lint. LOAD_STAGES_DEFAULTS is the SINGLE HOME of the two-tier evaluator's
...
// content/sda/src/analysis → ../../../.. is the repo root (the same climb the catalog generator uses).
