...
// @where-tested content/sda/src/analysis/system.e2e.test.ts, content/sda/src/analysis/sensitivity-matrix.test.ts
...
// @algorithms content/sda/src/analysis/system.ts, engine/solve/src/fixpoint/solve.ts,
//   engine/solve/src/network/build.ts, content/sda/src/analysis/queueing.ts
// @docs none
// @e2e content/sda/src/analysis/architectures.e2e.test.ts, content/sda/src/analysis/system.e2e.test.ts,
...
/** The cost DEPTH a real bill has: compute/storage + the most-missed data-transfer line, the grand
