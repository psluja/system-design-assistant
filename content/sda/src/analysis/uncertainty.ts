...
// @where-tested content/sda/src/analysis/uncertainty.test.ts (quantiles vs closed form; tornado laws)
...
// @algorithms content/sda/src/analysis/uncertainty.ts, engine/solver-contract/src/gpu/compile.ts,
//   engine/solver-contract/src/gpu/fp32.ts, engine/solver-contract/src/gpu/webgpu.ts
// @docs none
// @e2e none (unit + differential: content/sda/src/analysis/uncertainty.test.ts and
...
import { isTriangularRange, type Instance, type Range, type Wire } from '../vocabulary/manifest';
...
// ASSUMPTION UNCERTAINTY — Monte Carlo over the assumptions register. Every soft input becomes a declared RANGE; every conclusion becomes a
