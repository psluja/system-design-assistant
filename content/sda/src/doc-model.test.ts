...
// DOC MODEL (doc: design-doc-v2 R1) — the pure DATA the two renderers consume. These tests pin the MECHANICAL
...
describe('DocModel — structure & scope (owner ruling §6)', () => {
  ...
  it('a declared guarantee contribution rides the assumptions register with its provenance (doc: guarantee-propagation §4)', () => {
