...
import { categorical, dims } from './guarantees';
import { protocolCompat } from './protocols';
import { familyOf } from './synth-spec';
import type { ValueFn } from './system';
import type { Manifest } from './manifest';

// GUARANTEE REQUIREMENTS + VERDICTS + REMEDIATIONS (doc: guarantee-propagation §4, §5 R2). This is the categorical
...
/** A per-FLOW guarantee requirement (doc: guarantee-propagation §4): the flow from `source` to `terminal` must
