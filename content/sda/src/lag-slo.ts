...
// FLOW-SCOPED LAG SLOs + VERDICTS (doc: latency-semantics-v2 §3, §7 R2b). The NUMERIC twin of the categorical
...
/** A per-FLOW propagation-lag requirement (doc: latency-semantics-v2 §3): the journey from `source` to `terminal`
