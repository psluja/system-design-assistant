...
//   fixed seed reproduces byte-identical runs across machines (doc-4 §3c); Math.random is unseedable.
 ...
 * contract (doc-4 §3c) requires every draw to come from here, so a fixed seed ⇒ byte-identical runs.
 */
