...
/**
 * The hot-path engine entry (doc-4 §8): project the graph into a cell network, solve it to the least
 ...
 *
 * `classes` (doc: request-classes §3) is the OPTIONAL multi-commodity overlay: each declared class folds the flow
