...
// GUARANTEE PROPAGATION — the categorical counterpart of the numeric
...
/** The propagated result for ONE dimension along ONE flow. */
export interface DimensionResult {
   ...
   *. Independent of `token`, which still meets normally. */
...
/** A categorical REQUIREMENT declared on a flow: the flow's computed token for
...
/**
 * Judge one dimension's propagated result against a requirement, honestly:
