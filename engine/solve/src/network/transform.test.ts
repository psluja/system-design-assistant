...
// Port TRANSFORMS act on FLOW-flagged keys at the edge-contribution seam (doc: flow-transformations §3).
...
describe('per-WIRE transform override — the wire wins over the source port (doc: flow-transformations-r2 §5)', () => {
