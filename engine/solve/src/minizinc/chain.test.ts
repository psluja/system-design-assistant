...
// here would silently mis-simulate every feedback/backpressure design — a P0 (doc-4 §3a, §5, §9).
...
// path and MiniZinc must agree on it too (doc: flow-transformations-r2 §5). We build a real fan-out graph with a
