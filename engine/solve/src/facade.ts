 ...
 *  no-solution, per doc-4: uncertainty is a value). Injected so engine/solve stays independent of HOW
...
/**
 * The engine facade (doc-4 §8): one object exposing every mode over a fixed registry. The hot,
