...
/**
 * How a property composes over the topology — a monoid, parameterized by edge semantics.
...
export interface Aggregation {
  ...
  /** When true this is a FLOW quantity that PORT TRANSFORMS act on. At each
...
/** The engine knows the SHAPE of a key, never the specific keys (those are content). */
...
/** The governed vocabulary: a closed set of key definitions, looked up by key. */
