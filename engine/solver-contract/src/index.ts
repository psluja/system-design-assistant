// @sda/solver-contract — the heart of the project made explicit (phase 0). One small package that is three things at once:
...
// • @sda/solver-contract/harness — `oracleHarnessOf(candidate, { oracle })`: the ORACLE HARNESS (//     phase 1). A seeded random-design GENERATOR fans a candidate across many topologies/regimes; the incumbent
