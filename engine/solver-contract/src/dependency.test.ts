...
//       the pure-core checks below by the same rule (TASK-79 phase 2 added native under the incumbent's discipline).
...
// they may import @sda/engine-solve and are excluded from the pure-core checks. gpu/ (TASK-81) is the WebGPU
