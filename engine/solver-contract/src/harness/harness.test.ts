...
// THE SANITY GATE (TASK-79 phase 1): run the INCUMBENT as its OWN candidate through the oracle harness. The
...
// worthless as a grader. When the domain solver arrives (TASK-79 phase 2) its test file calls the SAME
