...
//   2000); equivalence rules are the contract's own (docs/design/solver-contract.html §5).
...
// THE ORACLE HARNESS — the RUNNER (docs/design/solver-contract.html §4, §7; TASK-79 phase 1). Where the
