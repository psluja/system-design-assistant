...
// THE ORACLE HARNESS — the ORACLE (docs/design/solver-contract.html §4; TASK-79 phase 1). The incumbent adapter
// (native MiniZinc/COIN-BC + clingo — the forever referee) answers every generated instance, and its answer is
// taken as CERTIFIED: this is the reference a candidate solver (TASK-79 phase 2) is graded against. The oracle
...
//
// WHY the oracle IS the incumbent (not a hand-written expected table): the whole point of TASK-79 is to replace
