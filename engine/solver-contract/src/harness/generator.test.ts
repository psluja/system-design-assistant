...
// The GENERATOR's own tests (TASK-79 phase 1). These pin the generator PURELY (no solver): every generated
...
describe('generator — the seeded random-design generator (TASK-79 phase 1)', () => {
...
// ── The HARDENING AXES (TASK-79 phase 3) — the generator's own proofs, no solver ──────────────────────────
...
describe('generator — the hardening axes (TASK-79 phase 3)', () => {
...
// ── THE CLASS AXIS (TASK-82 R4, doc: request-classes §5) — pinned PURELY, evaluated WITH classes ──────────────
...
describe('generator — the CLASS axis (TASK-82 R4, doc: request-classes §5)', () => {
