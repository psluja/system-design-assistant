...
// The ORACLE's own tests (TASK-79 phase 1): the incumbent (native MiniZinc/COIN-BC + clingo) certifies a
...
describe('oracle — the incumbent certifies generated answers (TASK-79 phase 1)', () => {
