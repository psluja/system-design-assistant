...
// THE METAMORPHIC LAYER — the instance TRANSFORMS (docs/design/solver-contract.html §4, §7; TASK-79 deeper
// distillation). The differential harness (./harness) proves a candidate matches the incumbent ANSWER-for-answer.
