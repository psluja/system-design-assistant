// CAPABILITY: Evaluate — the synchronous hot path (docs/design/solver-contract.html §3.1). Forward
 ...
 * aggregation) is bound once at adapter CONSTRUCTION, not per call (docs/design/solver-contract.html §9,
 * owner ruling: registry-at-construction) — so the request stays light and matches today's facade, which
 ...
 *   (2) the domain solver's CPU forward pass (TASK-79 layer 2, "CPU proves").
 */
