// CAPABILITY: EvaluateBatch — N evaluations, one call (docs/design/solver-contract.html §3.6). Evaluate the
...
// from docs/design/uncertainty-monte-carlo.html §2.
//
 ...
 *   (2) a WebGPU/WGSL batch proposer (TASK-79 layer 1, "GPU proposes").
 */
