// CAPABILITY: Enumerate — generate legal topologies (docs/design/solver-contract.html §3.5). GENERATE
 ...
 * (docs/design/solver-contract.html §3.5 honesty gap).
 */
 ...
 *   (2) a future in-house series-parallel enumerator (TASK-79 exploited-structure).
 */
