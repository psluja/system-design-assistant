// CAPABILITY: Optimize — search a knob against SLOs. Run the design
...
/**
 * A REQUEST CLASS: a named multi-commodity flow — its own acyclic wire membership
 ...
 * `class` names WHICH class's value to optimize. Absent ⇒ the class-blind
