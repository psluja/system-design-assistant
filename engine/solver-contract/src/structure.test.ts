...
describe('package structure — each solver ADAPTER mirrors the co-located-test template (incumbent + native)', () => {
  // TASK-79 phase 2: the native adapter mirrors the incumbent file-for-file — every source (INCLUDING the entry
...
describe('package structure — the oracle harness mirrors the same template (TASK-79 phase 1)', () => {
