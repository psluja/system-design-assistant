...
// THE NATIVE SEARCH's own tests (TASK-79 phase 2) — PURE: they exercise the CPU search directly with NO MiniZinc
...
describe('native search — the generated regimes and honesty states (TASK-79 phase 2)', () => {
