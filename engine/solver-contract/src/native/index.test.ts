...
// THE NATIVE ADAPTER's proof (TASK-79 phase 2). This is where our own solver is graded against the SAME two
...
describe('native adapter — capability set and the referee against the incumbent (TASK-79 phase 2)', () => {
  ...
  it('request classes: native SOLVES a headroom multi-class design and matches the incumbent optimum (TASK-82 R4)', async () => {
  ...
  it('request classes: native DECLINES at the shared-saturation boundary while the incumbent SOLVES (TASK-82 R4)', async () => {
