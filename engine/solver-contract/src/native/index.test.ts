...
describe('native adapter — capability set and the referee against the incumbent', () => {
  ...
  it('request classes: native DECLINES at the shared-saturation boundary while the incumbent SOLVES', async () => {
    ...
    // processor-sharing boundary. Native must return did-not-converge (honest), never a
  ...
  it('GENERATOR axis: native solves generate-driven load, matches the incumbent, and PEAK prices ≥ MEAN', async () => {
