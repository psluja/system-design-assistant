...
// TASK-79 phase 2). It is the SECOND implementation behind the same `SolverBindings` the incumbent implements,
...
// 17.8 MB MiniZinc bundle out of the graph — the whole reason TASK-79 exists.
