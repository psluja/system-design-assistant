// THE NATIVE ADAPTER — our own implementation of the solver contract. It is the SECOND implementation behind the same `SolverBindings` the incumbent implements,
...
export function makeNativeAdapter(deps: NativeDeps): SolverBindings {
  ...
  // The synchronous hot path — the engine's forward evaluator, CLASS-AWARE. It calls the
