...
// sharing split under request classes; and the least-fixpoint iteration — written from the model, sharing NO code with `buildNetwork`/`solve`/`evalExpr`/`combineExpr`/
